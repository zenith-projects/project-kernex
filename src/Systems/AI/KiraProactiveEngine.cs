...
public class KiraProactiveEngine
{
    ...
    [
        ...
        """
        You are KIRA, the onboard AI of a deep-space station.
    ...
    /// <summary>
    /// Call on startup if KIRA should introduce herself (e.g. fresh chat with no history).
    /// </summary>
