...
The research system is a **massive web of interconnected nodes** called **The Constellation**, inspired by Path of Exile and Albion Online. No locked branches — everything is reachable. Nodes unlock module blueprints, stat bonuses, capabilities, and passive effects. Modules must then be crafted after unlocking.

**Full documentation: [CONSTELLATION.md](CONSTELLATION.md)** | **Module catalog: [MODULES.md](MODULES.md)**

### Summary

| Aspect | Detail |
|--------|--------|
| **16 clusters** | Production, Defense, Offense, Fleet, Weapons, Drones, Exploration, Navigation, KIRA, Automation, Engineering, Economy, Stealth, Logistics, Colonization, Anomaly Science, Communications |
| **18 bridge nodes** | Connect adjacent clusters, dual bonuses, shortcut paths |
| **Node types** | Blueprint, Stat Bonus, Capability, Passive Effect, Keystone, Bridge |
| **16 keystones** | One per cluster edge — major game-changers (e.g., Fortress Protocol, Titan-Class, Quantum Consciousness) |
| **No locks** | Everything reachable — prioritize, don't abandon |
| **Research cost** | Inner (common) → Mid (uncommon) → Outer (rare) → Keystone (legendary) |
| **Pacing** | ~20h for one Keystone, ~200h for full Constellation |

### Module System

Modules are unlocked through the Constellation, then crafted/bought and installed. See [MODULES.md](MODULES.md).

- **13 categories** — Energy, Thermal, Weapons, Defense, Propulsion, Mining, Cargo, Tech, Automation, KIRA, Stealth, Comms, Colonization
- **5 rarities** — Common → Uncommon → Rare → Epic → Legendary
- **16 upgrade levels** — failure chance at 13-15, mitigated by KIRA
- **10 starter modules** pre-researched for new players
